...
async function signup(username: string, password: string, email?: string) {  // Make sure user is not logged in yet
  ...
  try {
    ...
    let errorMessage = "Signup failed. Error: " + error;
    alert(errorMessage);
    return;
  }
}
          ...
          <div className="mt-3">
            <button
              ...
              onClick={(e) => {
                ...
                signup(username.value, password.value, email.value || undefined);              }}
            >
              Sign up
            </button>
          </div>
